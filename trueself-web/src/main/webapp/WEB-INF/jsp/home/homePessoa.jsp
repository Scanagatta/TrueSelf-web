            ...
            <div class="col-xs-12 col-sm-6">
              ...
              <div class="table-responsive">
                <table class="table table-hover">
                  ...
                  <c:forEach var="comentario" items="${pessoaLogada.comentarios}">
					<tr>
